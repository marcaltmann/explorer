defmodule ExplorerWeb.Layouts do
    ...
    <div class={if @admin, do: "site site--admin", else: "site site--default"}>
      ...
      <footer class="footer u-mt-large">
        <div class="footer__inner">
          ...
          <a href="https://github.com/marcaltmann/explorer-ex" title="GitHub repository">
            <svg height="24px" viewBox="0 0 256 250" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
              preserveAspectRatio="xMidYMid" aria-label="GitHub logo">
                <g>
  ...
  def flash_group(assigns) do
    ~H"""
    <div id={@id} class="flash" aria-live="polite">
