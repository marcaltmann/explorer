defmodule ExplorerWeb.UserAuthTest do
  use ExplorerWeb.ConnCase, async: true

  alias Explorer.Accounts
  alias Explorer.Accounts.Scope
  alias ExplorerWeb.UserAuth

  import Explorer.AccountsFixtures

  @remember_me_cookie "_explorer_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, ExplorerWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
